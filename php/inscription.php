...
<!--------------------------------- Barre de Navigation --------------------------------------->
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-dark">
    <a class="navbar-brand" href="espace-membre.php"><img src="img/log.png" height="100" width="100"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
          <a class="nav-link text-white" href="espace-membre.php">Accueil<span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="accueil.php"><span class="sr-only">(current)</span></a>
        </li>
...
<body class="steep">
	...
	<br>
	<form id="leMien" action="analyse.php" method = 'post'>
